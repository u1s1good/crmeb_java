<template>
  <div class="page-account"
    :style="backgroundImages ? { backgroundImage: 'url(' + backgroundImages + ')' } : { backgroundImage: 'url(' + backgroundImageMo + ')' }">
      ...
      <div class="index_from page-account-container">
        ...
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on"
          ...
          <el-form-item prop="account">
            <el-input ref="account" v-model="loginForm.account" prefix-icon="el-icon-user" placeholder="用户名"
              name="username" type="text" tabindex="1" autocomplete="on" />
          </el-form-item>

          <el-form-item prop="pwd">
            <el-input :key="passwordType" ref="pwd" v-model="loginForm.pwd" prefix-icon="el-icon-lock"
              :type="passwordType" placeholder="密码" name="pwd" tabindex="2" auto-complete="on" />
    ...
    <div class="copyright">
      <a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank"> 赣ICP备2024021736号-1</a>
    </div>
  </div>
</template>
